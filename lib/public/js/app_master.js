...
ms.querySC = function(q) {
  ms.socket.emit('querySC', q, function(tracks){
    ...
    for(var i=0; i<tracks.length; i++) {
      ...
      item.innerHTML = '<div class="img" style="background-image:url('+tracks[i].artwork_url+')"></div><div class="info"><div class="name">'+tracks[i].title+'</div><div class="description">'+tracks[i].description+'</div></div><div class="btn">Select</div>';
